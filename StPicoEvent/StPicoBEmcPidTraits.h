...
inline Int_t   StPicoBEmcPidTraits::adc0() const { return (Int_t)mBTOWADC0; }
inline Float_t StPicoBEmcPidTraits::e0() const { return (Float_t)mBTOWE0 / 1000.; }
inline Float_t StPicoBEmcPidTraits::e() const { return (Float_t)mBTOWE / 1000.; }
inline Float_t StPicoBEmcPidTraits::zDist() const { return (Float_t)mBEMCDistZ / 100.; }
inline Float_t StPicoBEmcPidTraits::phiDist() const { return (Float_t)mBEMCDistPhi / 10000.; }
inline Int_t   StPicoBEmcPidTraits::nEta() const { return (Int_t)mBSMDNEta; }
inline Int_t   StPicoBEmcPidTraits::nPhi() const { return (Int_t)mBSMDNPhi; }
...
inline Float_t StPicoBEmcPidTraits::e1() const { return (Float_t)mBTOWE1 / 1000.; }
inline Float_t StPicoBEmcPidTraits::e2() const { return (Float_t)mBTOWE2 / 1000.; }
inline Float_t StPicoBEmcPidTraits::e3() const { return (Float_t)mBTOWE3 / 1000.; }
inline Float_t StPicoBEmcPidTraits::etaTowDist() const { return (Float_t)mBTOWDistEta / 10000.; }
inline Float_t StPicoBEmcPidTraits::phiTowDist() const { return (Float_t)mBTOWDistPhi / 10000.; }
#endif
